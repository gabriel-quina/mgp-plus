...
<header class="d-flex align-items-center justify-content-between mb-4">
    ...
    <div class="d-flex gap-2">
        <a href="{{ route('admin.cities.edit', $city) }}" class="btn btn-primary">Editar</a>
        ...
        <a href="{{ route('admin.cities.index') }}" class="btn btn-outline-secondary">Voltar</a>
    </div>
</header>
...
<div class="card">
    ...
    <div class="card-footer d-flex gap-2">
        <a href="{{ route('admin.cities.index') }}" class="btn btn-outline-secondary">Voltar</a>
        <a href="{{ route('admin.cities.edit', $city) }}" class="btn btn-primary">Editar</a>
        <form action="{{ route('admin.cities.destroy', $city) }}" method="POST" class="d-inline ms-auto"
              onsubmit="return confirm('Tem certeza que deseja excluir esta cidade?');">
            @csrf
            @method('DELETE')
            <button type="submit" class="btn btn-outline-danger">Excluir</button>
