...
@section('content')
    <div class="d-flex align-items-center justify-content-between mb-3">
        ...
        <div class="d-flex gap-2">
            @if (Route::has('admin.schools.create'))
                <a href="{{ route('admin.schools.create') }}" class="btn btn-primary">Nova Escola</a>
            @endif
        </div>
    </div>
    ...
    <form method="GET" action="{{ route('admin.schools.index') }}" class="row g-2 mb-3">
        <div class="col-md-6">
            <input type="text" name="q" class="form-control" placeholder="Buscar por escola, cidade ou UF…"
                value="{{ $q }}">
        </div>
        <div class="col-auto">
        ...
        <div class="col-auto">
            <a href="{{ route('admin.schools.index') }}" class="btn btn-outline-secondary">Limpar</a>
        </div>
    </form>
                ...
                @forelse ($schools as $school)
                    <tr>
                        ...
                        <td class="d-flex flex-wrap gap-2">
                            @if (Route::has('admin.schools.show'))
